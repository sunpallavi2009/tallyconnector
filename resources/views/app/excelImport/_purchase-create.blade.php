...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Purchase Invoices Import') }}</li>
@endsection
@section('content')
    <div class="row">
        <div class="col-sm-12">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="card">
                            <div class="tab-pane fade show active" id="apps-setting" role="tabpanel"
                                ...
                                {!! Form::open([
                                    'route' => ['excelImport.purchase.import'],
                                    'method' => 'Post',
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-12 px-3">
                                                <p class="mt-2" style="font-size: 18px;">
                                                    <a href="{{ asset('assets/exceldocument/Purchase-Invoice.xlsx') }}">Click here</a>
