...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('excelImport.ledgers.create') }}">{{ __('Ledger Import') }}</a></li>
    <li class="breadcrumb-item">{{ __('View Ledger') }}</li>
@endsection
@section('content')
    <div class="row">
        <div class="col-sm-12">
                ...
                <div class="col-xl-12">
                    <div class="card sticky-top">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            @include('app.excelImport.sidebar._ledger-sidebar')
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-lg-8 d-flex align-items-center">
                                            <h5 class="mb-0">{{ __('Ledger Data') }}</h5>
                                        </div>
