...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('excelImport.payment.create') }}">{{ __('Payment Voucher Import') }}</a></li>
    <li class="breadcrumb-item">{{ __('View Payment Voucher') }}</li>
@endsection
@section('content')
    <div class="row">
        <div class="col-sm-12">
                ...
                <div class="col-xl-12">
                    <div class="card sticky-top">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            @include('app.excelImport.sidebar._payment-sidebar')
                        </div>
                    </div>
                </div>
...
@push('javascript')
    ...
    <script>
        $(document).on('change', '.edit-transectionType-select', function() {
            var newValue = $(this).val();
            var id = $(this).data('id');
            var url = '{{ route("bankReceiptPayment.input.store", ":id") }}';
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#bank-table').DataTable().ajax.reload(); // Reload DataTable after successful update
                },
