    ...
    public function query(SalePurchaseInvoice $model)
    {
        return $model->newQuery()
            ->where(function($query) {
                $query->whereNull('gst_in')
                    ->Where('inv_amt', '>=', 250000);
            });
    }
                    ...
                    [
                        ...
                        'buttons' => [
                            [
                                ...
                                'exportOptions' => [
                                    'columns' => [0, 1, 3], // Define columns you want to export
                                ],
                            ],
                            [
                                'text' => '<i class="fas fa-file-excel"></i> Tally',
                                'className' => 'btn btn-light text-primary dropdown-item export-tally',
                                'exportOptions' => [
                                    'modifier' => [
